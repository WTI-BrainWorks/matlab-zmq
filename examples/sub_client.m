function sub_client(varargin)
    ...
    context = zmq.ctx_new();
    socket = zmq.socket(context, 'ZMQ_SUB');
    ...
    if (nargin > 1)
        zmq.disconnect(socket, address1);
    end
