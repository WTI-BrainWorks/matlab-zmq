function varargout = ctx_get(varargin)
% zmq.ctx_get - Mex function for interacting with ZMQ Contexts.
%
% Usage: output = zmq.ctx_get(context, option_name)
%
...
%                  (ZMQ_IO_THREADS and ZMQ_MAX_SOCKETS) or boolean (ZMQ_IPV6).
    ...
    [varargout{1:nargout}] = zmq.zmqcore('ctx_get', varargin{:});
end
